...
describe('SomfyProtectPlatform', () => {
  ...
  beforeEach(() => {
    ...
    mockApi = {
      ...
      platformAccessory: jest.fn((name, uuid, category) => ({
        UUID: uuid,
        displayName: name,
        context: {},
        getService: jest.fn(),
  ...
  describe('constructor', () => {
    ...
    it('should log error if username is missing', () => {
      ...
      const badPlatform = new SomfyProtectPlatform(mockLogger, badConfig, mockApi);
  ...
  describe('discoverSites', () => {
    ...
    it('should use specific site if siteId is configured', async () => {
      ...
      const platformWithSiteId = new SomfyProtectPlatform(
        mockLogger,
        configWithSiteId,
        mockApi,
      );
    ...
    it('should error if configured siteId not found', async () => {
      ...
      const platformWithBadSiteId = new SomfyProtectPlatform(
        mockLogger,
        configWithBadSiteId,
        mockApi,
      );
  ...
  describe('polling', () => {
    ...
    it('should use custom polling interval from config', async () => {
      ...
      const customPlatform = new SomfyProtectPlatform(mockLogger, customConfig, mockApi);
  ...
  describe('graceful shutdown', () => {
    ...
    it('should remove all event listeners on shutdown', () => {
      const listenerCountBefore = platform.events.eventNames().length;
